...
const CloudStrategy = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-background to-secondary/20">
      ...
      <SEO
        title="Cloud Strategy & Consulting | MangosOrange"
        description="Cloud readiness, migration planning, and cloud architecture design for secure, scalable growth."
        jsonLd={{
          ...
          areaServed: 'Global',
          description:
            'Cloud readiness assessment, migration planning and execution, and cloud architecture design.',
        }}
      />
