...
const ITServices = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Header />
      <Seo 
        title="IT Services | MangosOrange"
        description="End-to-end IT services: web, mobile apps, cloud infrastructure, open source customization, custom software, and e-commerce solutions."
        canonical={`${window.location.origin}/it-services`}
        jsonLd={{
          "@context": "https://schema.org",
          "@type": "ItemList",
          "itemListElement": [
            {"@type":"ListItem","position":1,"url":`${window.location.origin}/web-development`},
            {"@type":"ListItem","position":2,"url":`${window.location.origin}/app-development`},
            {"@type":"ListItem","position":3,"url":`${window.location.origin}/cloud-strategy`},
            {"@type":"ListItem","position":4,"url":`${window.location.origin}/open-source`},
            {"@type":"ListItem","position":5,"url":`${window.location.origin}/custom-software`},
            {"@type":"ListItem","position":6,"url":`${window.location.origin}/ecommerce`}
          ]
        }}
      />
      {/* Hero Section */}
